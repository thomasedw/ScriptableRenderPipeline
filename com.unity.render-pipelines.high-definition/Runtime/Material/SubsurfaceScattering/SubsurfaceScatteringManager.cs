...
namespace UnityEngine.Rendering.HighDefinition
{
    public partial class HDRenderPipeline
    {
            ...
            RTHandle diffuseBufferRT, RTHandle depthStencilBufferRT, RTHandle depthTextureRT)
        {
            ...
            using (new ProfilingScope(cmd, ProfilingSampler.Get(HDProfileId.SubsurfaceScattering, ProfilingType.CpuGpu)))
            {
                ...
                if (parameters.needTemporaryBuffer)
                {
                    ...
                    using (new ProfilingScope(cmd, ProfilingSampler.Get(HDProfileId.ClearSSSFilteringTarget, ProfilingType.Gpu)))
                    {
        ...
        static void RenderSubsurfaceScattering(in SubsurfaceScatteringParameters parameters, in SubsurfaceScatteringResources resources, CommandBuffer cmd)
        {
            ...
            using (new ProfilingScope(cmd, ProfilingSampler.Get(HDProfileId.HTileForSSS, ProfilingType.Gpu)))
            {
