...
namespace UnityEngine.Rendering.HighDefinition
{
    class HDRaytracingAmbientOcclusion
    {
        ...
        public void RenderAO(HDCamera hdCamera, CommandBuffer cmd, RTHandle outputTexture, ScriptableRenderContext renderContext, int frameCount)
        {
            ...
            using (new ProfilingScope(cmd, "Ray Trace Ambient Occlusion", HDProfileId.RaytracingAmbientOcclusion.GetSampler()))
            {
            ...
            using (new ProfilingScope(cmd, "Filter Ambient Occlusion", HDProfileId.RaytracingAmbientOcclusion.GetSampler()))
            {
