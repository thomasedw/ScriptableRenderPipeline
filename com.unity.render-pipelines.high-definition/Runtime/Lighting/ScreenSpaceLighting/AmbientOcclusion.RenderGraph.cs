...
namespace UnityEngine.Rendering.HighDefinition
{
    partial class AmbientOcclusionSystem
    {
        ...
        {
            using (var builder = renderGraph.AddRenderPass<RenderAOPassData>("GTAO Horizon search and integration", out var passData, ProfilingSampler.Get(HDProfileId.HorizonSSAO, ProfilingType.CpuGpu)))
            {
        ...
        {
            using (var builder = renderGraph.AddRenderPass<UpsampleAOPassData>("Upsample GTAO", out var passData, HDProfileId.ResolveSSAO.GetSampler()))
            {
                builder.EnableAsyncCompute(parameters.runAsync);
